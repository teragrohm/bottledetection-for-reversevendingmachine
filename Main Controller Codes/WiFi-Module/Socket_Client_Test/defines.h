...
const char* ssid = "tera"; //Enter SSID
const char* password = "TS899313"; //Enter Password

//const char* websockets_server_host = "192.168.2.95"; //Enter server address
const char* websockets_server_host = "192.168.41.181"; //Enter server address
//const char* websockets_server_host = "serverip_or_name"; //Enter server address

//#define WEBSOCKETS_PORT   80    //8080
#define WEBSOCKETS_PORT   100
